    ...
    <section class="section dashboard">
        <div class="row mt-2 mb-1">
            <div class="col-12">
                ...
                <?php endif; ?>
                <a href="<?= VIEWS . 'Leaves/calendar.php' ?>" class="btn btn-primary mt-2"><i class="bi bi-calendar me-1"></i>
                    Calendrier </a>
            </div>
        </div>
        ...
        <div class="row mt-1">
            <div class="col-12">
                ...
                <div class="card recent-sales overflow-auto">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">Planification des congés pour
                            <?= $current_year == 'all' ? 'toutes les années' : "l'année " . $current_year ?></h5>
                            ...
                            <table class="table table-border datatable">
                                ...
                                <tbody>
                                    <?php foreach ($leaves as $leave) : ?>
                                        <tr>
                                            <th scope="row"><a href="<?= VIEWS . 'Leaves' . DS . 'view.php?id=' . $leave->getId() ?>"><?= $leave->getId() ?></a>
                                            </th>
                                            <td>
