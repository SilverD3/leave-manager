                            ...
                            <table class="table table-striped table-bordered table-hover">
                                <tbody>
                                    <tr>
                                        <th>Intitulé</th>
                                        <td>
                                            <?php if (!empty($contract->getTitle())): echo $contract->getTitle(); else: ?>
                                                Contrat de l'employé <?= $contract->getEmployee()->getFirstName() . ' ' . $contract->getEmployee()->getLastName() ?>
                                            <?php endif;?>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <th>Date de fin</th>
                                        <td><?= !empty($contract->getEndDate()) ? DateHelper::shortDate($contract->getEndDate()) : '/' ?></td>
                                    </tr>
                                    <tr>
                                        <th>Poste occupé</th>
                                    ...
                                    <tr>
                                        <th>Salaire</th>
                                        <td><?= !empty($contract->getJobSalary()) ? UtilsHelper::currency((float)$contract->getJobSalary()) . ' XAF' : '/' ?></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><?= !empty($contract->getModified()) ? DateHelper::dateTime($contract->getModified()) : '/' ?></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                        ...
                        <?php else: ?>
                            <div class="p3">
                                <object width="100%" height="500" id="pdfPreview" type="application/pdf" data="<?= ASSETS . 'pdf/' . $contract->getPdf() ?>?#zoom=100&scrollbar=1&toolbar=1&navpanes=0">
                                    <p>Une erreur est survenue lors de l'affichage du contrat. <a href="<?= ASSETS . 'pdf/' . $contract->getPdf() ?>" target="_blank">Essayer d'ouvrir dans une autre page <i class="bi bi-arrow-up-right-square"></i></a></p>
                                </object>
                            </div>
                        <?php endif; ?>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="extendContractLabel"><i class="bi bi-arrow-clockwise"></i> Choisir le statut des contrat à afficher</h5>
