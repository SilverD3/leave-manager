...
(new ContractModelsController())->add();
...
<main id="main" class="main">
    <div class="pagetitle">
        <h1>Ajouter un modèle de contrat</h1>
        <nav>
            <ol class="breadcrumb">
                    ...
                    <div class="card-body">
                        ...
                        <form class="row g-3 needs-validation" action="" method="post" novalidate>
                            <div class="mb-1">
                                ...
                                <input type="text" maxlength="255" class="form-control" name="name" id="cmname" value="<?= isset($form_data['name']) ? $form_data['name'] : '' ?>" required>
                            ...
                            <div class="col-sm-6">
                                ...
                                <?php else : ?>
                                    <select id="cmctid" class="form-select" name="contract_type_id" required>
                                        <option selected value="">Choisir un type de contrat</option>
                                        <?php foreach ($contract_types as $ctype) : ?>
                                            <option <?= (isset($form_data['contract_type_id']) && $form_data['contract_type_id'] == $ctype->getId()) ? 'selected' : '' ?> value="<?= $ctype->getId() ?>">
                                                <?= $ctype->getName(); ?>
                                            </option>
                                        <?php endforeach; ?>
                                    </select>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" name="content" id="cmcontent" rows="3" required><?= isset($form_data['content']) ? $form_data['content'] : '' ?></textarea>
                                <div class="invalid-feedback">Veuillez renseigner le contenu du modèle de contrat.</div>
                            </div>

                            <div class="mb-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="is_current" value="1" id="cmiscurrent">
                                    <label class="form-check-label" for="cmiscurrent">Définir comme modèle par défaut</label>
                                </div>
                            </div>

                            <div class="text-center">
                                <input type="submit" class="btn btn-primary" name="add_contract_model" value="Ajouter">
